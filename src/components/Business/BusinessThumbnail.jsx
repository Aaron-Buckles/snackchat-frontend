                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            <address>
                                ...
                                {props.business.city}, {props.business.state}, {props.business.postal_code}
                            </address>
                        </Card.Text>
                        <Card.Text>
                            Ratings: {props.business.starRating}
                        </Card.Text>
                        <h4>
                        ...
                        <Button variant="success" onClick={handleWriteReview}>Write a review</Button>
                    </Card.Body>
                </div>
            </div>
        </Card>
